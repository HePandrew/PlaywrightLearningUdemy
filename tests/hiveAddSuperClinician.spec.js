const {test, expect} = require('@playwright/test');
    ...
    const lastName = "Clinician";
    const email = "SC0001@mailinator.com";
    const mobile = "504452158";
    const empNo = "SC0001";
...
test('adding super clinician', async ({page})=>
{
    ...
    await page.locator('#ddlusertype').selectOption("Super Clinician");
...
test.only('checking super clinician', async ({page})=>
    {
    await page.locator('text="Clinical Users"').click();
    ...
    console.log("Given Super Clinician is present in table")
