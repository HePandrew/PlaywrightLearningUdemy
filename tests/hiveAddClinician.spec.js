const {test, expect} = require('@playwright/test');
    ...
    const firstName = "Cli";
    const lastName = "nician";
    const email = "C0001@mailnator.com";
    const mobile = "504452159";
    const empNo = "C0001";
...
test('adding clinician', async ({page})=>
{
    ...
    await page.locator('#ddlusertype').selectOption("Clinician");
...
test('checking  clinician', async ({page})=>
    {
    await page.locator('text="Clinical Users"').click();
    ...
    console.log("Given Clinician is present in table")
