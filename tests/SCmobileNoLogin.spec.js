...
test('SC mobile number login - HA001', async ({page})=>
    {
    const MobileNo = "502547693";
    const Password = "Test123";
    const SCemail = "xeroaug24@gmail.com";
    ...
    await page.goto(URL);
    await page.locator('a.text-center').click({ timeout: 3000 });
    ...
    expect(profileMail.includes(SCemail)).toBeTruthy();
